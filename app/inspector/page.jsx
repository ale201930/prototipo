    ...
    <div className="page-dashboard">
      ...
      <main className="page-main animate-fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            { icon: 'fa-clipboard-list', label: 'Registro de Asistencia', sub: 'Marcar entradas y salidas del personal', route: '/inspector/registro-asistencia', color: '#06b6d4', bg: 'rgba(6,182,212,0.08)' },
            { icon: 'fa-user-group', label: 'Control de Visitantes', sub: 'Registro de ingreso y salida de visitantes', route: '/inspector/visitantes', color: '#3b82f6', bg: 'rgba(59,130,246,0.08)' },
          ].map(item => (
